...
//
// D-046: the pure validator moved to ./_pure/field-validation.ts so it can be
// unit-tested without the drizzle client. Re-exported here so existing import sites
// (set-field-value.ts, launch-run.ts, the @virn/database barrel) are unchanged.
// ---------------------------------------------------------------------------

export { validateFieldValue } from "./_pure/field-validation";
