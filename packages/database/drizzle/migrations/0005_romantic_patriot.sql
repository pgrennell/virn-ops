...
ALTER TABLE "participant" ADD CONSTRAINT "participant_identity" CHECK ((
        ("participant"."kind" = 'user' and "participant"."user_id" is not null and "participant"."guest_email" is null and "participant"."agent_id" is null and "participant"."vendor_id" is null and "participant"."vendor_contact_id" is null) or
        ("participant"."kind" = 'guest' and "participant"."guest_email" is not null and "participant"."user_id" is null and "participant"."agent_id" is null and "participant"."vendor_id" is null and "participant"."vendor_contact_id" is null) or
        ("participant"."kind" = 'agent' and "participant"."agent_id" is not null and "participant"."user_id" is null and "participant"."guest_email" is null and "participant"."vendor_id" is null and "participant"."vendor_contact_id" is null) or
        ("participant"."kind" = 'vendor' and "participant"."vendor_id" is not null and "participant"."vendor_contact_id" is not null and "participant"."user_id" is null and "participant"."guest_email" is null and "participant"."agent_id" is null)
      ));